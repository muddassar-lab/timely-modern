...
const schema = z.object({
	name: z
		...
		.max(255, { message: 'Name can be at most 255 characters' }),
	date_of_birth: z.date({ required_error: 'Date of birth is required' }),
	email: z
		.string({ required_error: 'Email is required' })
		.email({ message: 'Email is invalid' })
		.max(255, { message: 'Email can be at most 255 characters' }),
	phone: z.string({ required_error: 'Phone is required' }).regex(/^923\d{9}$/, {
		message: 'Phone number should start with 923 and be exactly 12 digits'
	})
})
